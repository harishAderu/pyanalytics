...
print(support3)
print(support3[['antecedents', 'consequents', 'support','confidence','lift']])
#---
support2 = association_rules(frequent_itemsets, metric="support", min_threshold = .2)
print(support2[['antecedents', 'consequents', 'support','confidence','lift']])

#%%%% Lift
#lift1 = association_rules(frequent_itemsets, metric=["lift","confidence"], min_threshold=[1,0.5])
...
print(confidence6[['antecedents', 'consequents', 'support','confidence','lift']])
...
print(rules4[['antecedents', 'consequents', 'ant_len', "con_len",'confidence']])
...
association_rules = apriori(df, min_support=0.0045, min_confidence=0.2, min_lift=1, min_length=1)
